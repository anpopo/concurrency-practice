...
import anpopo.stockissue.service.PessimisticLockStockService;
...
class LettuceLockServiceTest {
    ...
    @Test
    public void requestHundredsLettuceSetnxLock () throws InterruptedException {
        int threadCount = 100;
        ...
        for (int i = 0; i < threadCount; i++) {
            executorService.submit(() -> {
                try {
                    lettuceLockService.decrease(1L, 1L);
